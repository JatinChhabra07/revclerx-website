...
const principles = [
  { tag: 'P1', title: 'Outcomes over output.', body: 'A model in a notebook is not an outcome. We define the metric on day one and own it through deployment.', color: 'text-[#1f4d3a]', span: 2 as const },
  { tag: 'P2', title: 'Security as default.', body: 'Air-gapped, on-premise, hybrid, or cloud. The architecture decision starts with your data residency and compliance posture.', color: 'text-[#1f4d3a]', span: 1 as const },
  { tag: 'P3', title: 'Speed without shortcuts.', body: 'Four week POCs are the norm. We get there by removing process bloat, not by skipping reviews.', color: 'text-[#1f4d3a]', span: 2 as const },
  { tag: 'P4', title: 'Integration is the product.', body: 'If it does not slot into your ERP, your CRM, or your data lake, it does not ship. We treat connectors as first-class work.', color: 'text-[#1f4d3a]', span: 1 as const },
  { tag: 'P5', title: 'Stay after launch.', body: 'Models drift. Regulations change. We monitor, retrain, and optimize so the value compounds rather than decays.', color: 'text-[#1f4d3a]', span: 1 as const },
  { tag: 'P6', title: 'Honest about limits.', body: 'If AI is not the right answer, we will tell you on day one. We have walked away from work that was not ready for AI.', color: 'text-[#1f4d3a]', span: 1 as const },
]

const milestones = [
  { year: '2022', color: 'text-[#1f4d3a]', title: 'Founded.', body: 'Three founders, one thesis. Enterprise AI is bottlenecked by integration and governance, not by models.' },
  { year: '2023', color: 'text-[#1f4d3a]', title: 'First production deployments.', body: 'Shipped fraud detection, document processing, and predictive maintenance for early enterprise partners.' },
  { year: '2024', color: 'text-[#1f4d3a]', title: 'Crossed 25 deployments.', body: 'Expanded into healthcare, retail, and logistics. Released the Assess, Accelerate, Sustain methodology.' },
  { year: '2025', color: 'text-[#1f4d3a]', title: '50 plus deployments.', body: 'Launched the Managed AI Operations practice. Strategic partnerships with Nervesparks and Xsparks.ai.' },
  { year: '2026', color: 'text-[#1f4d3a]', title: 'Today.', body: 'Operating across North America, Europe, and APAC. Twelve plus industries served and 94% client retention.' },
]
    ...
    <PageShell>
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-24 relative">
          <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">About RevClerx</span>
          ...
          <div className="mt-3 text-5xl md:text-7xl font-bold tracking-tight leading-[1.05]">
            <HighlightText color="rgba(167, 139, 250, 0.35)">
              <span className="bg-[#1f4d3a] hover:bg-[#163829] bg-clip-text text-transparent">We ship.</span>
            </HighlightText>
          </div>
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-start relative">
          <Reveal>
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">Mission</span>
          ...
          <Reveal>
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">Approach</span>
          ...
          <div className="md:col-span-2 mt-6 flex justify-center">
            <div className="w-40 h-40 text-[#1f4d3a]/40">
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="max-w-3xl">
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">Principles</span>
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="text-center max-w-3xl mx-auto">
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">By the numbers</span>
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
            <Reveal className="rounded-2xl border border-slate-200 bg-white shadow-sm p-7 text-center">
              <div className="text-4xl md:text-5xl font-bold bg-[#1f4d3a] hover:bg-[#163829] bg-clip-text text-transparent tabular">
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="max-w-3xl">
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">Timeline</span>
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="max-w-3xl">
            <span className="text-xs uppercase tracking-[0.25em] text-[#1f4d3a]">Leadership</span>
