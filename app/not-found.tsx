  ...
  return (
    <PageShell>
      <section className="flex-1 flex items-center justify-center relative overflow-hidden">
        <div className="blob blob-green w-[480px] h-[480px] -top-24 -left-24"></div>
        <div className="blob blob-green w-[420px] h-[420px] bottom-0 -right-32"></div>
        <div className="max-w-4xl mx-auto px-6 py-24 text-center relative">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/" className="inline-flex items-center gap-2 rounded-full bg-[#1f4d3a] hover:bg-[#163829] px-7 py-3.5 text-sm font-semibold text-white shadow-md shadow-black/10 hover:shadow-black/10 transition">Back to Home <span aria-hidden>{'→'}</span></Link>
