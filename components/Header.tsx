  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-white/85 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link
          href="/contact"
          className="hidden sm:inline-flex items-center gap-2 rounded-full bg-[#1f4d3a] hover:bg-[#163829] px-5 py-2 text-sm font-medium text-white shadow-md shadow-black/10 hover:shadow-black/10 transition"
        >
