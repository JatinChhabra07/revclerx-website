...
/**
 * Confetti — canvas-based particle explosion. Fire on form submits,
 * pricing-tier selection, "free trial started" moments.
 *
 ...
 *   <Confetti active={fire} />
 *   <button onClick={() => setFire(true)}>Start free trial</button>
 */
