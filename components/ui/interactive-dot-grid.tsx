...
/**
 * InteractiveDotGrid — canvas-based dot grid that reacts to cursor.
 * Dots near the cursor swell + glow. Disabled on touch devices.
 *
 * Use as a hero background for tech / AI / dev-tool brands.
 *
...
export function InteractiveDotGrid({
  ...
  useEffect(() => {
    ...
    // Skip on mobile / touch devices (canvas + mousemove wouldn't work well)
