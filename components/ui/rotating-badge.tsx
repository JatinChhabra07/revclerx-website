...
/**
 * RotatingBadge — like TextRotate but wrapped as a branded "badge"
 * with background color (e.g., CTA gradient). Use in hero eyebrows:
 *   "Optimized for [Real Estate | SaaS | E-commerce]"
 *
 * Source: Revun-Website / Revun-Saas
 */
